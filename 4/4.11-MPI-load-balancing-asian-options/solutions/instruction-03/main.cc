...
This file, labs/4/4.11-MPI-load-balancing-asian-options/solutions/instruction-03/main.cc,
...
int main(int argc, char **argv) {
  ...
  int haveThreads;
  //  MPI_Init(&argc, &argv);
  MPI_Init_thread(&argc, &argv, MPI_THREAD_MULTIPLE, &haveThreads);
  assert(haveThreads==MPI_THREAD_MULTIPLE);
